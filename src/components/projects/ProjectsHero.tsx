      ...
      <div className="container-custom relative z-10">
        <div className="text-center animate-slideUp">
          ...
          <h1 className="font-outfit text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6">
            Signature <span className="text-transparent bg-clip-text bg-gradient-to-r from-luxury-gold to-[#E5D4B8]">Projects</span>
          </h1>
          <p className="text-white/60 text-lg max-w-3xl mx-auto leading-relaxed">
            Explore our curated collection of luxury interior projects that showcase our craftsmanship and design excellence.
          </p>
        </div>
      </div>
