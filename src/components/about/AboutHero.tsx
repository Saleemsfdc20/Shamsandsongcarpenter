      ...
      <div className="container-custom relative z-10">
        <div className="text-center animate-slideUp">
          ...
          <h1 className="font-outfit text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6">
            Mumbai&apos;s Premier <span className="text-transparent bg-clip-text bg-gradient-to-r from-luxury-gold to-[#E5D4B8]">Interior Experts</span>
          </h1>
          <p className="text-white/60 text-lg max-w-3xl mx-auto leading-relaxed">
            With over a decade of excellence in interior design and carpentry, we&apos;ve transformed hundreds of spaces into stunning living environments.
          </p>
        </div>
      </div>
